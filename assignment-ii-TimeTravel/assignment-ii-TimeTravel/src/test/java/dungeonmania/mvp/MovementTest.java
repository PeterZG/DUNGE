...
public class MovementTest {
    ...
    @Test
    @Tag("1-5")
    @DisplayName("Test the player cannot move right")
    public void testMovementRightButWall() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse initDungonRes = dmc.newGame("d_basicGoalsTest_WallBetweemExit1",
                "c_movementTest_testMovementRight");
        EntityResponse initPlayer = TestUtils.getPlayer(initDungonRes).get();
    ...
    @Test
    @Tag("1-6")
    @DisplayName("Test the player cannot move left")
    public void testMovementLeftButWall() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse initDungonRes = dmc.newGame("d_basicGoalsTest_WallBetweemExit3",
                "c_movementTest_testMovementLeft");
        EntityResponse initPlayer = TestUtils.getPlayer(initDungonRes).get();
    ...
    @Test
    @Tag("1-7")
    @DisplayName("Test the player cannot move down")
    public void testMovementDownButWall() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse initDungonRes = dmc.newGame("d_basicGoalsTest_WallBetweemExit4",
                "c_movementTest_testMovementDown");
        EntityResponse initPlayer = TestUtils.getPlayer(initDungonRes).get();
    ...
    @Test
    @Tag("1-2")
    @DisplayName("Test the player cannot move up")
    public void testMovementUpButWall() {
        DungeonManiaController dmc = new DungeonManiaController();
        DungeonResponse initDungonRes = dmc.newGame("d_basicGoalsTest_WallBetweemExit2",
